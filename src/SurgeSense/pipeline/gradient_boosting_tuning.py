...
from SurgeSense.components.hyperparameter_gradientboost import hyperOptTraining
from SurgeSense import logger 

STAGE_NAME='Model Trainer Stage'


class ModelTrainerTrainingPipelineGradientBoosting:
    def __init__(self):
        pass

    def main(self):
        config=ConfigurationManager()
        hyperopt_config=config.get_hyperopt_config_GradientBoosting()
...
if __name__=='__main__':
    try:
        ...
        obj=ModelTrainerTrainingPipelineGradientBoosting()
        obj.main()
